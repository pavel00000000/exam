...
namespace RussianFrench
{
    class RussianFrenchDictionary
    {
        private Dictionary<string, List<string>> dictionary;

        public RussianFrenchDictionary()
        {
        ...
        public void AddWordTranslation()
        {
            ...
            Console.Write("Введите перевод слова на французком: ");
            ...
            using (StreamWriter writer = new StreamWriter("русско- французкий словарь.txt", true))
            {
        ...
        public void ReplaceWordTranslation()
        {
            ...
            if (dictionary.ContainsKey(word))
            {
                ...
                Console.Write("Введите новый перевод слова на французком: ");
                ...
                List<string> fileLines = File.ReadAllLines("русско- французкий словарь.txt").ToList();
                ...
                fileLines.Add("");
                File.WriteAllLines("русско- французкий словарь.txt", fileLines);
            }
            else
            {
