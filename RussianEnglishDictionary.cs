...
namespace RussianEnglish
{
    class RussianEnglishDictionary
    {
        private Dictionary<string, List<string>> dictionary;

        public RussianEnglishDictionary()
        {
        ...
        public void AddWordTranslation()
        {
            ...
            Console.Write("Введите перевод слова на английский: ");
            ...
            using (StreamWriter writer = new StreamWriter("русско - английский словарь.txt", true))
            {
        ...
        public void ReplaceWordTranslation()
        {
            ...
            if (dictionary.ContainsKey(word))
            {
                Console.Write("Введите новое слово на русском: ");
                string newWord = Console.ReadLine();

                Console.Write("Введите новый перевод слова на английском: ");
                ...
                List<string> fileLines = File.ReadAllLines("русско - английский словарь.txt").ToList();
                ...
                fileLines.Add("");
                File.WriteAllLines("русско - английский словарь.txt", fileLines);
            }
            else
            {
        ...
        public void DeleteWordTranslation()
        {
            ...
            if (dictionary.ContainsKey(word))
            {
                ...
                string[] fileLines = File.ReadAllLines("русско - английский словарь.txt");
                ...
                File.WriteAllLines("русско - английский словарь.txt", updatedFileLines);
            }
            else
            {
                Console.WriteLine("Слово не найдено.");
        ...
        public void SearchTranslation()
        {
            ...
            Console.Write("Введите слово на русском для поиска перевода: ");
            string word = Console.ReadLine();
