...
namespace EnglishRussian
{
    class EnglishRussianDictionary
    {
        ...
        public void AddWordTranslation()
        {
            ...
            using (StreamWriter writer = new StreamWriter("англо-русский словарь.txt", true))
            {
        ...
        public void ReplaceWordTranslation()
        {
            ...
            if (dictionary.ContainsKey(word))
            {
                ...
                List<string> fileLines = File.ReadAllLines("англо-русский словарь.txt").ToList();
                ...
                fileLines.Add(""); 
                File.WriteAllLines("англо-русский словарь.txt", fileLines);
            }
            else
            {
